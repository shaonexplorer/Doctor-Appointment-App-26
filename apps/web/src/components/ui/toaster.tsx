...
function ToastTitle({ className, children }: { className?: string; children: React.ReactNode }) {
  return <div className={cn('text-sm font-semibold', className)}>{children}</div>;
}
ToastTitle.displayName = 'ToastTitle';

function ToastDescription({ className, children }: { className?: string; children: React.ReactNode }) {
